...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"splashpos=m,m\0"					\
		"lvds_num=1\0"                   \
		"bootargs=console=ttymxc1,115200 init=/init video=mxcfb0:dev=hdmi,1280x800M@60,if=RGB24,bpp=32 video=mxcfb1:off video=mxcfb2:off fbmem=28M vmalloc=400M androidboot.console=ttymxc1 androidboot.hardware=freescale " MEMORY_SIZE_PARAM "\0"
#endif
